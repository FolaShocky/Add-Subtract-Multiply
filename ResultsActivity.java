...
public class ResultsActivity extends AppCompatActivity
{
    ...
    public void FileLogic()
    {
...

        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.ADD_EASY_QUESTION_COUNT,0)/sharedPreferences.getInt("Add|Easy|Score",0)
       ...
       else if (difficulty.equalsIgnoreCase("Medium") && category.equals("Add"))
        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.ADD_MEDIUM_QUESTION_COUNT,sharedPreferences.getInt("minutes",1)*20)
                    /sharedPreferences.getInt("Add|Medium|Score",0)&&BeatsPreviousScore("Add|Medium|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
        ...
        else if (difficulty.equalsIgnoreCase("Hard") && category.equals("Add"))
        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.ADD_HARD_QUESTION_COUNT,
                    sharedPreferences.getInt("minutes",1)*20)/sharedPreferences.getInt("Add|Hard|Score",0)&&BeatsPreviousScore("Add|Hard|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
...

        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.SUBTRACT_EASY_QUESTION_COUNT,sharedPreferences.getInt("minutes",1)*20)
                    /sharedPreferences.getInt("Subtract|Easy|Score",0)&&BeatsPreviousScore("Subtract|Easy|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
        ...
        else if (difficulty.equalsIgnoreCase("Medium") && category.equals("Subtract"))
        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.SUBTRACT_MEDIUM_QUESTION_COUNT, sharedPreferences.getInt("minutes", 1) * 20)
                    / sharedPreferences.getInt("Subtract|Medium|Score", 0)&&BeatsPreviousScore("Subtract|Medium|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
            ...
            if (sharedPreferences.getInt("Subtract|Hard|Score", 0) == 0 && BeatsPreviousScore("Subtract|Hard|Score"))
                {
                 ...
                 else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.SUBTRACT_HARD_QUESTION_COUNT,
                         sharedPreferences.getInt("minutes",1)*20)
                         /sharedPreferences.getInt("Subtract|Hard|Score",0)&&BeatsPreviousScore("Subtract|Hard|Score"))
                 {
                     etxtName.setVisibility(View.VISIBLE);
                     etxtName.setEnabled(true);
                     txtLength.setVisibility(View.VISIBLE);
        ...
        if (difficulty.equalsIgnoreCase("Easy") && category.equals("Multiply"))
        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.MULTIPLY_EASY_QUESTION_COUNT,
                    sharedPreferences.getInt("minutes", 1) * 20) / sharedPreferences.getInt("Multiply|Easy|Score", 0)&& BeatsPreviousScore("Multiply|Easy|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
        ...
        else if (difficulty.equalsIgnoreCase("Medium") && category.equals("Multiply"))
        {
            if (sharedPreferences.getInt("Multiply|Medium|Score", 0) == 0 && BeatsPreviousScore("Multiply|Medium|Score"))
            {
                ...
                if (!etxtName.getText().toString().trim().equals(""))
                {
                    ...
                    sharedPreferences.getInt(PrefStrings.MULTIPLY_MEDIUM_QUESTION_COUNT,sharedPreferences.getInt("minutes",1)*20)
                            /sharedPreferences.getInt("Multiply|Medium|Score",0)&& BeatsPreviousScore("Multiply|Medium|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
        ...
        else if (difficulty.equalsIgnoreCase("Hard") && category.equals("Multiply"))
        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.MULTIPLY_HARD_QUESTION_COUNT,sharedPreferences.getInt("minutes",1)*20)
                    /sharedPreferences.getInt("Multiply|Hard|Score",0)&& BeatsPreviousScore("Multiply|Hard|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
        ...
        if (difficulty.equalsIgnoreCase("Easy") && category.equals("Random"))
        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.RANDOM_EASY_QUESTION_COUNT,sharedPreferences.getInt("minutes",1)*20)
                    /sharedPreferences.getInt("Random|Easy|Score",0)&& BeatsPreviousScore("Random|Easy|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
        ...
        else if (difficulty.equalsIgnoreCase("Medium") && category.equals("Random"))
        {
            ...
            else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.RANDOM_MEDIUM_QUESTION_COUNT,sharedPreferences.getInt("minutes",1)*20)
                    /sharedPreferences.getInt("Random|Medium|Score",0)&& BeatsPreviousScore("Random|Medium|Score"))
            {
                etxtName.setVisibility(View.VISIBLE);
                etxtName.setEnabled(true);
                txtLength.setVisibility(View.VISIBLE);
        ...
        else if (difficulty.equalsIgnoreCase("Hard") && category.equals("Random"))
        {
                ...
                else if (minsDivByQuestionCount < sharedPreferences.getInt(PrefStrings.RANDOM_HARD_QUESTION_COUNT,sharedPreferences.getInt("minutes",1)*20)
                        /sharedPreferences.getInt("Random|Hard|Score",0) && BeatsPreviousScore("Random|Hard|Score"))
                {
                    etxtName.setVisibility(View.VISIBLE);
                    etxtName.setEnabled(true);
                    txtLength.setVisibility(View.VISIBLE);
